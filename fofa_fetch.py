...
def get_isp_by_regex(ip):
    """通过IP地址正则匹配运营商（增强版）"""
    # 电信IP段
    if (re.match(r"^(1[0-9]{2}|2[0-3]{2}|5|8|14|17|40|42|43|45|58|59|60|61|62|63|64|66|69|74|81|82|94|101|103|106|110|111|112|113|114|115|116|117|118|119|120|121|1
    22|123|124|125|126|127|128|129|130|131|132|134|139|140|144|145|146|147|148|150|152|153|154|155|156|157|158|159|160|161|162|163|166|167|170|175|180|182|183|1
    84|185|186|187|188|189|192|193|195|198|199|202|203|207|210|211|212|218|219|220|221|222|223)\.", ip) or
